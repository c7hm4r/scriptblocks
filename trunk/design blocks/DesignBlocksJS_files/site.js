...
function getFooter(){
	...
	//$('#mainbottom').append('<div id="create"><a href="'+url+'" title="Create a new design" target="_blank"><img src="http://www.designblocks.net/assets/create.png"></a></div>');
